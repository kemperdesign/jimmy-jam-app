      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-zinc-300">St Augustine Stockyards<br />St Augustine, St Augustine, Florida</p>
              </div>
        ...
        {activeNav === 'maps' && (
          <div className="space-y-4 pb-20">
            ...
            {activeTab === 'venue' && (
              <div className="space-y-4">
                <div className="w-full h-96 bg-gradient-to-br from-gray-300 to-gray-200 rounded-lg flex items-center justify-center border-2 border-zinc-800 shadow-lg text-center">
                  <div>
                    <p className="text-6xl mb-3">🎪</p>
                    <p className="text-zinc-300 font-bold text-lg">Venue Floor Plan</p>
                    <p className="text-sm text-zinc-300 mt-2">St Augustine Stockyards</p>
                    <p className="text-xs text-zinc-400 mt-1">July 4-5, 2024</p>
                  </div>
                </div>

                {/* LEGEND */}
                <div className="bg-zinc-900 rounded-lg p-4 border-2 border-zinc-800 space-y-3">
                  <h3 className="font-bold text-zinc-100 mb-3">Legend</h3>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-zinc-8000 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">BBQ Stage</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">Food Vendors</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">Bourbon Bar</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-yellow-500 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">Restrooms</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-purple-500 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">First Aid</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-orange-500 rounded"></div>
                      <span className="text-sm font-semibold text-zinc-300">Parking</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'gps' && (
              <div className="space-y-4">
                ...
                {/* LOCATION INFO */}
                <div className="bg-zinc-900 rounded-lg p-4 border-2 border-blue-300 space-y-3">
                  <h3 className="font-bold text-zinc-100">St Augustine Stockyards</h3>
                  <p className="text-sm text-zinc-300">2501 Meacham Blvd, St Augustine, FL 76106</p>
